...
namespace FKGame.UIWidgets{
	public class UINotificationSlot : UISlot<UINotificationOptions> {
        [SerializeField]
        ...
        public override void Repaint()
        {
            ...
            {
                UINotification container = Container as UINotification;
                if (this.m_Text != null)
                {
		...
		private void DelayCrossFade(Graphic graphic, UINotificationOptions options){
            if((Container as UINotification).fade)
