...
namespace FKGame.InventorySystem
{
	...
	{
		private const string componentToolbarMenu = "Tools/FKGame/Inventory System/Components/";

		[MenuItem ("Tools/FKGame/Inventory System/Editor", false, 0)]
		private static void OpenItemEditor ()
		{
			InventorySystemEditor.ShowWindow ();
		}

		[MenuItem("Tools/FKGame/Inventory System/Merge Database", false, 1)]
		private static void OpenMergeDatabaseEditor()
		{
			MergeDatabaseEditor.ShowWindow();
		}

		[MenuItem("Tools/FKGame/Inventory System/Item Reference Updater", false, 2)]
		private static void OpenItemReferenceEditor()
		{
			ItemReferenceEditor.ShowWindow();
		}

		[MenuItem ("Tools/FKGame/Inventory System/Create Inventory Manager", false, 3)]
