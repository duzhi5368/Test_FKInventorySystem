...
namespace FKGame
{
    public static class SDKManager
    {
        ...
        private static bool s_useNewSDKManager = false;                                                     // 是否使用新版本SDKManager
        private static List<PayPlatformInfo> allPayPlatformInfos;
        public static Dictionary<string, string> propertiesNoRepackage = new Dictionary<string, string>();  // 非经过重打包 本地设置的渠道参数
        ...
        {
            // pc平台下读取 \Configs\{properties}.ini配置文件
