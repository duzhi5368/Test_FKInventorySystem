...
//------------------------------------------------------------------------
// 镜头特效：震动
// 挂载到camera上之后，在其他地方调用 CameraEffects.Shake(); 即可
//------------------------------------------------------------------------
namespace FKGame
{
    public class ComponentCameraEffects : MonoBehaviour
    {
        ...
        {
            var instance = ((camera != null) ? camera : Camera.main).gameObject.AddComponent<ComponentCameraEffects>();
