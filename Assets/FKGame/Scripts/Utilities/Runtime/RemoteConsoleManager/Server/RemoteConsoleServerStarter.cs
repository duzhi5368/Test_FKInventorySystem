...
namespace FKGame
{
    public class RemoteConsoleServerStarter : MonoBehaviour
    {
        public static RemoteConsoleServerStarter Instance;
        ...
        private static void Init()
        {
            if (Instance == null)
            {
                Instance = new GameObject("[ConsoleServer]").AddComponent<RemoteConsoleServerStarter>();
            }
            if (Instance.isInit)
                return;
        ...
        public static bool ConsoleStart()
        {
            ...
            Debug.Log("RemoteConsole NetServer.port:" + config.netPort);
            isStart = true;
            return true;
        }
