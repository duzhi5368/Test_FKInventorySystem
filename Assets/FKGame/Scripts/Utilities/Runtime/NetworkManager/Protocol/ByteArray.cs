...
namespace FKGame
{
    public class ByteArray
    {
        ...
        private static byte[] int32Cache = new byte[4];
        private static byte[] int16Cache = new byte[2];
        private static byte[] int64Cache = new byte[8];
        ...
        public double ReadDouble()
        {
            for (int i = 0; i < 8; i++)
            {
                int64Cache[7 - i] = Bytes[i + Postion];
            }
            Postion += 8;
            return BitConverter.ToDouble(int64Cache, 0);
        }
        ...
        public void WriteDouble(double v)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                int64Cache[7 - i] = temp[i];
            }
            Bytes.AddRange(int64Cache);
        }
