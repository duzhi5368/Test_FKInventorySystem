...
namespace FKGame
{
    ...
    public class JsonNetworkService : INetwork
    {
        ...
        public const char c_endChar = '&';                              // 消息结尾符
        public const string c_endCharReplaceString = "<FCP:AND>";       // 文本中如果有结尾符则替换成这个
        private Queue<string> mesQueue = new Queue<string>();           // 消息队列
