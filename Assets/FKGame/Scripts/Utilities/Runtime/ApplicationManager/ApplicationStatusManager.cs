...
namespace FKGame
{
    ...
    {
        public static IApplicationStatus s_currentAppStatus;        // 当前程序所在状态
        public static string s_currentAppStatusName;
        public static CallBack<IApplicationStatus> OnStatusChangeCallBack;
        static Dictionary<string, IApplicationStatus> s_status = new Dictionary<string, IApplicationStatus>();  // 可切换状态
