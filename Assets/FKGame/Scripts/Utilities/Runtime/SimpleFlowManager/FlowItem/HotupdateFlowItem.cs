...
namespace FKGame
{
    public class HotupdateFlowItem : FlowItemBase
    {
        ...
        public const string P_HotUpdatePathData = "HotUpdatePathData.txt";                  // 热更新配置文件名
        public const string P_SelectHotUpdateTestPath = "SelectHotUpdateTestPath";          // 测试热跟新地址保存名称(使用远程工具修改)
        ...
        private void GetHotUpdatePath(List<HotUpdatePathData> datas, string error)
        {
            ...
            else
            {
                ...
                {
                    m_HotupdatePath = testPath; // 使用测试地址
                }
