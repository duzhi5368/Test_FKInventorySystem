...
namespace FKGame
{
    public class EditorDrawGUIUtil
    {
        ...
        public static bool IsDrawPropertyInClass = true;        // 全局控制EditorDrawGUIUtil绘制类时是否绘制属性
        public static bool CanEdit = true;                      // 全局控制EditorDrawGUIUtil绘制时是否可编辑
        private static bool richTextSupport = false;            // 控件文本是否支持富文本
        ...
        /// <param name="callAffterDrawField">每绘制一个字段后的调用函数</param>
        /// <returns></returns>
