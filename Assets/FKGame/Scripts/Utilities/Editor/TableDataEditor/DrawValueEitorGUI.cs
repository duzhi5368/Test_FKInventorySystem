...
namespace FKGame
{
    public class DrawValueEitorGUI
    {
        public static bool SupportValueType(object data)
        {
            ...
            else if (type == typeof(AnimationClip) || type == typeof(Texture2D) || type == typeof(Texture) ||
                type == typeof(Sprite) || type == typeof(AnimatorController) || type.BaseType == typeof(UnityEngine.Object) ||
                type.BaseType == typeof(Component) || type.BaseType == typeof(MonoBehaviour)) { }
